...
const NewsCategoryPage = async ({ params }) => {
  ...
  return (
    <div className=" grid grid-col-6 md:grid-cols-12 gap-4">
      <div className="md:col-span-3 p-4">
        <LeftSidebar newsCatagories={newsCatagories} activeId={id} />
      </div>
      <div className=" font-bold text-2xl md:col-span-6 ">
        <h2 className="text-xl font-semibold mb-4">
          {currentCategory.category_name || "All Categories"}
        </h2>
      ...
      <div className="md:col-span-3 hidden md:grid  p-4">
        <RightSidebar />
      </div>
    </div>
  );
